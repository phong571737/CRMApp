...
import com.example.crmmobile.OpportunityDirectory.Goal;
import com.example.crmmobile.R;

import java.util.List;

public class AdapterGoal extends RecyclerView.Adapter<AdapterGoal.GoalViewHolder> {

    private List<Goal> goalList;

    public AdapterGoal(List<Goal> goalList) {
